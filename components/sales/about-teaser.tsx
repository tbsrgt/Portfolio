    ...
    <section aria-labelledby="about-teaser-heading" className="px-6 sm:px-10">
      <FadeIn className="mx-auto max-w-275">
        <div className="border-foreground/8 bg-background/85 flex flex-col gap-8 rounded-4xl border p-6 sm:p-10 md:flex-row md:items-center md:gap-12">
          <Portrait alt={copy.about.photoAlt} className="aspect-square w-32 sm:w-44" />
          <div className="flex flex-col">
            <p className="text-foreground/50 mb-4 text-xs font-semibold tracking-[0.18em] uppercase">{sales.aboutEyebrow}</p>
            <h2 id="about-teaser-heading" className="text-foreground font-serif text-[2rem] leading-[1.1] font-medium tracking-tight sm:text-[2.5rem]">
              {sales.aboutHeading}
            </h2>
            <p className="text-foreground/65 mt-4 max-w-[58ch] text-[17px] leading-relaxed">{sales.aboutText}</p>
